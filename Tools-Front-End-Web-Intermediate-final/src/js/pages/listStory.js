  ...
  render() {
    if (this.isLoading) {
      ...
      return html`
        ...
        const formattedDateDetail = new Date(story.createdAt).toLocaleDateString('id-ID', {
          ...options,
          hour: 'numeric',
          minute: 'numeric',
        });
                ...
                <div class="card mb-4 custom-card">
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-end">
                      <span class="badge text-danger p-1 rounded-pill">${formattedDate}</span>
                    </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      />
                      <div class="d-flex justify-content-end">
                        <span class="badge text-danger p-1 rounded-pill">${formattedDateDetail}</span>
                      </div>
